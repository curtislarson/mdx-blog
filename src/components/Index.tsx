...
export default function Index({ header, footer, avatar, title, description, posts, theme }: IndexProps) {
  return (
    <div class="home" data-theme={theme}>
      {header || <IndexHeader title={title} avatar={avatar} description={description} />}
